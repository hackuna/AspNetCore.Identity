...
namespace AspNetCore.Identity.Data.Protection;

public class ApplicationILookupProtectorKeyRing : ILookupProtectorKeyRing
{
    private readonly IDictionary<string, string> _keyDictionary = new Dictionary<string, string>();

        public ApplicationILookupProtectorKeyRing(IWebHostEnvironment hostingEnvironment)
        {
